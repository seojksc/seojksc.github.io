...
[2] Motor Hotspot Localization Based on Electroencephalography Using Convolutional Neural Network in Patients with Stroke

11 March 2024, BioRxiv (Preprint), doi: https://doi.org/10.1101/2024.03.06.583618

Ga-Young Choi, Jeong-Kweon Seo, Kyoung Tae Kim, Won Kee Chang, Nam-Jong Paik, Won-Seok Kim, Han-Jeong Hwang

*

[3] A reduced order modeling using the frequency-domain method for parabolic partial differential equations
...
[4] A Pretraining Domain Decomposition Method Using Artificial Neural Networks To Solve Elliptic PDE Boundary Value Problems
...
[5] Reduced order modeling of the elliptic systems of the frequency-domain method and its error estimation
...
[6] A cognitive sample consensus method for the stitching of drone-based aerial images supported by generative adversarial network for the false positive reduction
...
[7] A Posteriori Outlier Rejection Approach Owing to the Well-ordering Property of a Sample Consensus Method for the Stitching of Drone-based Thermal Aerial Images
...
[8] Experimental Optimal Choice Of Initial Candidate Inliers Of The Feature Pairs With Well-Ordering Property For The Sample Consensus Method In The Stitching Of Drone-based Aerial Images
...
[9] Termite population size estimation based on termite tunnel patterns using a convolutional neural network
...
[10] Simulating the architecture of a termite incipient nest using a convolutional neural network
...
[11] Differentiation of the Follicular Neoplasm on the Gray-Scale US by Image Selection Subsampling along with the Marginal Outline Using Convolutional Neural Network
...
[12] 컴퓨터도움진단(Computer-Aided Diagnosis) 기술과 인공지능(AI)
...
[13] LEAST-SQUARES SPECTRAL COLLOCATION PARALLEL METHODS FOR PARABOLIC PROBLEMS
...
[14] NUMERICAL SOLUTIONS OF BURGERS EQUATION BY REDUCED-ORDER MODELING BASED ON PSEUDO-SPECTRAL COLLOCATION METHOD
...
[15] Reduced Order Medeling With Pseudospectral Element Method On Burgers' Equation
...
[16] Estimation of termite population size using convolution neural network
